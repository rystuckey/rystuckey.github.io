...
# Manoa Social: A Social Media App for UH Manoa
...
- **Landing Page:** A welcoming homepage explaining the purpose of Manoa Social, with a preview of recent posts and buttons to sign up or log in.
- **Login / Register Page:** A page where users can create an account and sign in to access posting and interaction features.
- **Main Timeline Page:** The core page of the application, showing all posts in a single scrollable feed. Users can browse recent posts, sort them, and interact with them.
- **Create Post Page:** A form where logged-in users can create a new post with a title, body, and optional category tag such as academics, events, housing, clubs, or advice.
- **Post Detail Page:** A page for viewing one post in full, along with comments and discussion underneath it.
- **User Profile Page:** A page where each user can view their own posts, saved posts, and profile information.
- **Admin / Moderation Page:** A page for basic moderation tools such as reviewing flagged posts or removing inappropriate content.

All pages will be responsive and styled with Bootstrap 5 so they work well on both desktop and mobile devices.

### Use Case Ideas

- A student wants to know how difficult a certain class is and makes a post asking for advice from other UH Manoa students.
- A club officer posts information about an upcoming event so students can discover it through the campus feed.
- A student posts that they are selling a used textbook, and interested students can comment or message them.
- A freshman asks for recommendations about parking, food, or study spots and gets answers from more experienced students.
- A user logs in and sees their own posting history, saved posts, and content related to topics they interact with most.
